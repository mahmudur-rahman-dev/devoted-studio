...
export const projectsData: ProjectDetails[] = [
  {
    ...
    completionDate: "2022",
    description:
      "Milvik Bangladesh office space designed with modern aesthetics and functional workspace solutions.",
    images: [
      {
...
export const getRelatedProjects = (
  ...
  return projectsData
    .filter(
      (project) => project.category === categoryType && project.id !== currentId
    )
    .slice(0, limit);
};
