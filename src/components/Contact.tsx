    ...
    <div className="bg-light py-20" id="contact">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
          ...
          <div>
            <h3 className="mb-6 text-2xl font-bold text-dark">Our Office</h3>
          ...
          <div>
            <h3 className="mb-6 text-2xl font-bold text-dark">Contact us</h3>
            <form className="space-y-6">
              <div>
                <input
                  type="text"
                  placeholder="Name*"
                  className="w-full rounded-md border border-gray-300 px-4 py-3 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-primary"
                  required
                />
              </div>
              ...
              <div>
                <button
                  type="submit"
                  className="flex items-center bg-gold px-8 py-3 font-medium text-dark transition-all hover:bg-opacity-90"
                >
